...
export default function TrackingScreen() {
  ...
  const { isTracking, lastLocation, locationCount, startTracking, resumeTracking, stopTracking } =
    useLocationTracking();
  ...
  const handleStop = () => {
    Alert.alert('Dừng hành trình', 'Bạn có chắc muốn dừng theo dõi hành trình này?', [
      { text: 'Huỷ', style: 'cancel' },
      {
        ...
        onPress: async () => {
          ...
          if (storedTripId) {
            ...
            await supabase.from('trips').update({ is_active: false }).eq('id', storedTripId);
          }
          router.replace('/(tabs)');
        },
      },
    ...
    <ThemedView style={styles.container}>
      <SafeAreaView style={styles.safeArea}>
        ...
        <Pressable
          ...
          onPress={handleStop}>
          <ThemedText style={styles.stopButtonText}>🛑 Dừng hành trình</ThemedText>
        </Pressable>
      </SafeAreaView>
    </ThemedView>
  );
